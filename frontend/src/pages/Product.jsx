      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex flex-col gap-4 my-8'>
            <p className='font-bold text-start'>Select Size</p>
          ...
          <button onClick={() => addToCart(productData._id, size)} className='flex bg-black text-white px-8 py-3 text-sm active:bg-gray-700'>ADD TO CART</button>
          <hr className='mt-8 sm:w-4/5' />
          <div className='text-sm text-start text-gray-600 mt-5 flex flex-col gap-1'>
